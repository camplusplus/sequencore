...
- Chord edit mode (blue modifier + long-press a grid pad with note) uses four pages to add up to 31 higher notes; selected chord notes play together with the base note
